      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.p
            ...
            className="text-lg md:text-xl text-slate-300 mb-10 max-w-2xl mx-auto text-pretty"
          >
          ...
          >
            <Button
              size="lg"
              className="bg-gold hover:bg-gold-dark text-navy font-semibold px-8 py-6 text-lg"
            ...
            <Button
              size="lg"
              variant="outline"
              className="border-slate-400 text-slate-200 hover:bg-slate-800 hover:text-white px-8 py-6 text-lg bg-transparent"
